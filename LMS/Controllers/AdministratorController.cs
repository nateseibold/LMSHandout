    ...
    public class AdministratorController : Controller
    {
        ...
        public IActionResult GetCourses(string subject)
        {
            var query = from i in db.Courses
                        ...
                        select new { number = i.Number, name = i.Name };
        ...
        public IActionResult GetProfessors(string subject)
        {
            var query = from i in db.Professors
                        where i.Subject == subject
                        select new { lname = i.LName, fname = i.FName, uid = i.UId };
            return Json(query.ToArray());
        }
        ...
        public IActionResult CreateClass(string subject, int number, string season, int year, DateTime start, DateTime end, string location, string instructor)
        {
            try 
	        {
                ...
                class1.StartTime = TimeOnly.FromDateTime(start);
                class1.EndTime = TimeOnly.FromDateTime(end);
                class1.Location = location;
                class1.Professor = profQuery.ToArray()[0];
